...
a{text-decoration:none;color:inherit}.wrap{max-width:1200px;margin:0 auto;padding:20px;display:grid;gap:16px}
.btn,.btn:visited{appearance:none;border:1px solid var(--dp-red);background:var(--dp-red);color:#fff !important;border-radius:12px;padding:10px 14px;font-weight:700;cursor:pointer;display:inline-flex;align-items:center;justify-content:center;gap:8px;text-align:center;min-height:42px;line-height:1.15;text-decoration:none !important}
.btn:hover{filter:brightness(.97)}
.btn--ghost,.btn--ghost:visited{background:#fff;color:#111 !important;border:1px solid var(--line)}
...
.pg2Cards{display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:12px}.pg2Card{position:relative;border:1px solid var(--line);border-radius:16px;background:#fff;overflow:hidden;box-shadow:0 6px 16px rgba(0,0,0,.04)}.pg2CardBadge{position:absolute;top:10px;left:10px;background:var(--dp-red);color:#fff;font-size:11px;border-radius:999px;padding:4px 8px;z-index:2}.pg2CardImg{width:100%;height:170px;object-fit:cover;background:#f3f3f3}.pg2CardImg--placeholder{display:grid;place-items:center;font-size:48px;font-weight:800;color:#999}.pg2CardBody{padding:12px;display:grid;gap:6px}.pg2CardMeta{font-size:12px;color:var(--muted)}.pg2CardPrice{font-size:18px;font-weight:800}.pg2CardActions{display:flex;gap:8px;flex-wrap:wrap;margin-top:6px}.pg2CardActions .btn{flex:1 1 auto}.pg2Social{display:inline-flex;padding:8px 12px;border-radius:999px;background:#f5f5f5;border:1px solid #e8e8e8;color:#111;text-decoration:none;font-weight:700}
.pg2CartBlock{display:grid;gap:12px}.pg2CartList{display:grid;gap:10px}.pg2CartRow{display:flex;justify-content:space-between;gap:12px;align-items:center;border:1px solid var(--line);border-radius:14px;padding:10px;background:#fff}.pg2CartInfo{display:grid;gap:3px}.pg2CartInfo span{font-size:12px;color:var(--muted)}.pg2CartQty{display:flex;align-items:center;gap:8px;flex-wrap:wrap}.btn--mini,.btn--mini:visited{padding:4px 8px;font-size:12px;border-radius:10px;min-height:32px}.pg2CartFoot{display:flex;justify-content:space-between;align-items:center;gap:12px;flex-wrap:wrap;border-top:1px dashed #e3e3e3;padding-top:10px}.pg2CartBtns{display:flex;gap:8px;flex-wrap:wrap}
